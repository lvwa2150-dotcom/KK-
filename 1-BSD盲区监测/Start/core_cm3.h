...
/** @addtogroup CMSIS_CM3_DWT 
  memory mapped structure for Data Watchpoint and Trace
  @{
 */
typedef struct
{
  __IO uint32_t CTRL;                         /*!< Offset: 0x00  DWT Control Register */
  __IO uint32_t CYCCNT;                       /*!< Offset: 0x04  DWT Cycle Count Register */
  ...
  __IO uint32_t FOLDCNT;                      /*!< Offset: 0x18  DWT Folded-instruction Count Register */
